...
export default function({name, price, type,navigation}) {
    return (
        <View style={{flexDirection: 'row', gap: 10, marginVertical: 20}}>
            ...
            <View style={{ flexGrow: 1}}>
                <View style={{flexDirection: 'row', flexGrow: 1, justifyContent: 'space-between',}}>
                    <Text style={{fontWeight: 500, fontSize: 17, color: 'rgba(0,0,0, .8)'}}>{name} Laptop[</Text>
                ...
                <View>
                    <Text style={{fontSize: 12, color: 'rgba(0,0,0, .5)'}}>{type} Laptop</Text>
                </View>
