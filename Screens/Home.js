...
export default function Home({navigation}){
    return (
        <Container>
            ...
            <Text style={{marginVertical: 10, fontSize: 18, fontWeight: 500, color: 'rgba(0,0,0, .4)'}}>Explore from our <Text style={{fontSize: 20, fontWeight: 700, color:'#f17827'}}>Quality Laptops</Text></Text>
            ...
            <View style={{marginTop: 20, marginBottom: 100, flexDirection: 'row', flexWrap: 'wrap', rowGap: 20, columnGap: 20, width: '92%', marginHorizontal: 'auto'}}> {/* width is hacky*/}
