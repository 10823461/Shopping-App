...
export default function Home(){
    return (
        <Container>
            ...
            <Text style={{marginVertical: 10, fontSize: 18, fontWeight: 500, color: 'rgba(0,0,0, .4)'}}>Your Home of <Text style={{fontSize: 20, fontWeight: 700, color:'#f17827'}}>Quality Laptops</Text></Text>
            ...
            <ScrollView horizontal={true}>
                <View style={{flexDirection: 'row', marginTop: 5}}>
                    ...
                    <Text style={styles.categoryItem}>Hp</Text>
                    <Text style={styles.categoryItem}>Acer</Text>
                    <Text style={styles.categoryItem}>Mcbook</Text>
                    <Text style={styles.categoryItem}>Lenovo</Text>
                </View>
            </ScrollView>
            </ScrollView>
            </SafeAreaView>
